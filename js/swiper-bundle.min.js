...
!(function (e, t) {
  ...
  const re = [
          ...
          if (
            ...
            a.each((e) => {
              ...
              a === p && t.addClass(s.bulletActiveClass),
                s.dynamicBullets &&
                  (a >= i && a <= o && t.addClass(`${s.bulletActiveClass}-main`), a === i && c(t, 'prev'), a === o && c(t, 'next'));
            });
          else {
            const e = a.eq(p),
              r = e.index();
    ...
    function (e) {
      ...
      function d() {
        return (
          !!s.autoplay.running && void 0 !== t && (t && (clearTimeout(t), (t = void 0)), (s.autoplay.running = !1), n('autoplayStop'), !0)
        );
      }
      function c(e) {
        s.autoplay.running &&
